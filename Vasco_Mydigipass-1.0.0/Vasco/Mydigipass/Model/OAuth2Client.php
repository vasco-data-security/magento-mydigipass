 ...
 */
class Vasco_Mydigipass_Model_OAuth2Client {
  ...
  public function api($path, $method = 'GET', $params = array()) {
    ...
    if (is_array($result) && isset($result['error'])) {
      $e = new Vasco_Mydigipass_Model_OAuth2Exception($result);
      switch ($e->getType()) {
    ...
    if ($this->getVariable('access_token_uri') && $this->getVariable('client_id') && $this->getVariable('client_secret')) {
      return json_decode($this->makeRequest(
        ...
        array(
          ...
          'code' => $code,
          'redirect_uri' => $this->getVariable('callbackUrl'),
        )
      ), TRUE);
    }
    return NULL;
  ...
  protected function makeRequest($path, $method = 'GET', $params = array(), $ch = NULL) {
    ...
    if ($result === FALSE) {
      $e = new Vasco_Mydigipass_Model_OAuth2Exception(array(
        'code' => curl_errno($ch),
